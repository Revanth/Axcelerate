...
const SectionHeader: React.FC<SectionHeaderProps> = ({activity, onClick}) =>{
    return (
        <div onClick={(e:React.MouseEvent) => onClick(e, activity)} className='bg-white hover:cursor-pointer hover:bg-gray-100 items-center flex w-3/4 md:w-1/2 h-6 md:h-12 border-t border-b border-gray-300'>
